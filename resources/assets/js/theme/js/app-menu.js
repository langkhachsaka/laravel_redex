...
(function(window, document, $) {
            ...
            if (this.collapsed === false) {
                ...
                this.transit(function() {
                    ...
                    /*if( $body.data('menu') == 'vertical-menu-modern' && defMenu === 'collapsed' ){
                      let $listItem = $('.main-menu li.open'),
        ...
        changeMenu: function(screen){
            ...
            if(screen == 'sm' || screen == 'xs'){
                ...
                megaMenuCol.each(function(index, el) {
                    ...
                    let megaMenuSub = $(el).find('.mega-menu-sub');
                    ...
                    let first_child = $(el).children().first(),
                        first_child_text = '';
    ...
    $.app.nav = {
        ...
        bind_events: function() {
            return; // TODO prevent change DOM of Menu @FGC
            let menuObj = this;
            ...
            $('.navigation-main').on('mouseenter.app.menu', 'li', function() {
                ...
                if( ($body.hasClass('menu-collapsed') && $body.data('menu') != 'vertical-menu-modern') || ($body.data('menu') == 'vertical-compact-menu' && !$body.hasClass('vertical-overlay-menu')) ){
                    ...
                    // Title
                    let menuTitle = $this.find('span.menu-title').clone(),
                        tempTitle,
                        tempLink;
                    ...
                    if($this.hasClass('has-sub') && $this.hasClass('nav-item')) {
                        let menuContent = $this.children('ul:first');
            ...
            function modernMenuExpand(){
                if( $body.data('menu') == 'vertical-menu-modern'){
                    ...
                    if($body.hasClass('menu-collapsed')){
                        let $listItem = $('.main-menu li.menu-collapsed-open'),
                            $subList = $listItem.children('ul');
        ...
        adjustSubmenu: function ( $menuItem ) {
            let menuHeaderHeight, menutop, topPos, winHeight,
