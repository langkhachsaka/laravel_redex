...
class SearchForm extends Component {
    ...
    render() {
        const searchDisabled = _.get(this.props.userPermissions, 'china_order.search_disabled', {});
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <Field
                            ...
                            select2Options={{
                                placeholder: searchDisabled.user_purchasing_id ? this.props.authUser.name : 'Tất cả',
                                allowClear: true,
                                ajax: {
                            ...
                            disabled={searchDisabled.user_purchasing_id}
                        />
                    </div>
                    <div className="col-sm-4">
