...
class CreateTaskReceiveShipmentForm extends Component {
    ...
    handleSubmit(formProps) {
        ...
        return ApiService.post(Constant.resourcePath('createTaskReceiveShipment'), {...formProps,shipment_code : this.state.models})
        .then(({data}) => {
            data.data.map(item => {
        ...
        return (
            <form className="form-horizontal" onSubmit={handleSubmit(this.handleSubmit.bind(this))}>
                ...
                <fieldset className="fiedset-verify-customer-order bgc-grey">
                    <legend  className="legend-account-deposited">Danh sách mã lô hàng</legend>
                    <div className="row">
                ...
                <div className={"row"}>
                    <div className="col-sm-3">
                        <Field
                            ...
                            label="Chọn nhân viên nhập hàng vào kho"
                            required={true}
...
export default connect(null, mapDispatchToProps)(reduxForm({
    form: 'CreateTaskReceiveShipmentForm'
})(CreateTaskReceiveShipmentForm))
