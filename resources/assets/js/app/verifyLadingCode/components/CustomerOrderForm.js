    ...
    fetchData(id) {
        return ApiService.get(Constant.resourcePath('getCustomerOrderDetail/'+id)).then(({data: {data}}) => {
            this.setState({
                ...
                isLoading: false,
                ladingCode :data.ladingCode[0].warehouse_vn_lading_item.code,
                length : data.ladingCode[0].warehouse_vn_lading_item.length,
                height :data.ladingCode[0].warehouse_vn_lading_item.height,
                width : data.ladingCode[0].warehouse_vn_lading_item.width,
                weight :data.ladingCode[0].warehouse_vn_lading_item.weight,
            });
            this.props.change("lading_code",data.ladingCode[0].code)
        });
    }
                ...
                <div>
                    ...
                    {this.state.models.map(item=> {
                        return item.bill_code.customer_order_items.map(customer_order_item=> {
                            ...
                            index = index + 1;
                            this.props.change(quantity_verify,this.state.verifyItem[index-1].quantity_verify)
                            this.props.change(note,this.state.verifyItem[index-1].note)
                            return (
                                <fieldset key={index} className="fiedset-verify-customer-order">
                                                    ...
                                                    <fieldset key={item.id} className="fiedset-verify-customer-order mgt-10 bgc-grey">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-sm-7">
                                                                ...
                                                                />
                                                                <div className="row">
                                                                    <div className={"col-sm-3"+(this.state.verifyItem[index-1].is_error_size && this.state.verifyItem[index-1].is_error_size == 1 ? " red-color-bold-text" : "")}>
                                                                        Sai cỡ
                                                                    </div>
                                                                    <div className="col-sm-2">
                                                                        <Field
                                                                            label=""
                                                                            checked={this.state.verifyItem[index-1].is_error_size && this.state.verifyItem[index-1].is_error_size == 1 ? true : false}
                                                                            name={is_error_size}
                                                                            component={CheckboxInput}
                                                                        />
                                                                    </div>
                                                                    <div className={"col-sm-3"+(this.state.verifyItem[index-1].is_error_color && this.state.verifyItem[index-1].is_error_color == 1 ? " red-color-bold-text" : "")}>
                                                                        Sai màu
                                                                    </div>
                                                                    <div className="col-sm-2">
                                                                        <Field
                                                                            label=""
                                                                            checked={this.state.verifyItem[index-1].is_error_color && this.state.verifyItem[index-1].is_error_color == 1 ? true : false}
                                                                            name={is_error_color}
                                                                            component={CheckboxInput}
                                                                        />
                                                                    </div>
                                                                ...
                                                                <div className="row">
                                                                    <div className={"col-sm-3"+(this.state.verifyItem[index-1].is_error_product && this.state.verifyItem[index-1].is_error_product == 1 ? " red-color-bold-text" : "")}>
                                                                        Sai hàng
                                                                    </div>
                                                                    <div className="col-sm-2">
                                                                        <Field
                                                                            label=""
                                                                            checked={this.state.verifyItem[index-1].is_error_product && this.state.verifyItem[index-1].is_error_product == 1 ? true : false}
                                                                            name={is_error_product}
                                                                            component={CheckboxInput}
                                                                        />
                                                                    </div>
                                                                    <div className={"col-sm-3"+(this.state.verifyItem[index-1].is_broken_gash && this.state.verifyItem[index-1].is_broken_gash == 1 ? " red-color-bold-text" : "")}>
                                                                        Bẹp, vỡ, rách
                                                                    </div>
                                                                    <div className="col-sm-2">
                                                                        <Field
                                                                            label=""
                                                                            checked={this.state.verifyItem[index-1].is_broken_gash && this.state.verifyItem[index-1].is_broken_gash == 1 ? true : false}
                                                                            name={is_broken_gash}
                                                                            component={CheckboxInput}
                                                                        />
                                                                    </div>
                                                                ...
                                                                <div className="row">
                                                                    <div className={"col-sm-3"+(this.state.verifyItem[index-1].is_exuberancy && this.state.verifyItem[index-1].is_exuberancy == 1 ? " red-color-bold-text" : "")}>
                                                                        Thừa sản phẩm
                                                                    </div>
                                                                    <div className="col-sm-2">
                                                                        <Field
                                                                            label=""
                                                                            checked={this.state.verifyItem[index-1].is_exuberancy && this.state.verifyItem[index-1].is_exuberancy == 1 ? true : false}
                                                                            name={is_exuberancy}
                                                                            component={CheckboxInput}
                                                                        />
                                                                    </div>
                                                                    <div className={"col-sm-3"+(this.state.verifyItem[index-1].is_inadequate && this.state.verifyItem[index-1].is_inadequate == 1 ? " red-color-bold-text" : "")}>
                                                                        Thiếu sản phẩm
                                                                    </div>
                                                                    <div className="col-sm-2">
                                                                        <Field
                                                                            label=""
                                                                            checked={this.state.verifyItem[index-1].is_inadequate && this.state.verifyItem[index-1].is_inadequate == 1 ? true : false}
                                                                            name={is_inadequate}
                                                                            component={CheckboxInput}
                                                                        />
                                                                    </div>
                                    ...
                                    {this.state.verifyItem[index-1].image1 &&
                                    <fieldset key={index} className="fiedset-verify-customer-order bgc-grey">
                                        ...
                                        <div>
                                            ...
                                            <div style={{float :'left'}}>
                                                <a href ={UrlHelper.imageUrl(this.state.verifyItem[index-1].image1)} target="_blank"><img src={UrlHelper.imageUrl(this.state.verifyItem[index-1].image1)} className="img-thumbnail-verify"
                                                        alt=""/></a>
                                            </div>}
                                            {this.state.verifyItem[index-1].image2 &&
                                            <div style={{float :'left'}}>

                                                <a href ={UrlHelper.imageUrl(this.state.verifyItem[index-1].image2)} target="_blank"><img src={UrlHelper.imageUrl(this.state.verifyItem[index-1].image2)} className="img-thumbnail-verify"
                                                        alt=""/></a>
                                            </div>}
                                            {this.state.verifyItem[index-1].image3 &&
                                            <div style={{float :'left'}}>
                                                <a href ={UrlHelper.imageUrl(this.state.verifyItem[index-1].image3)} target="_blank"><img src={UrlHelper.imageUrl(this.state.verifyItem[index-1].image3)} className="img-thumbnail-verify"
                                                        alt=""/></a>
                                            </div>}
                                            {this.state.verifyItem[index-1].image4 &&
                                            <div style={{float :'left'}}>
                                                <a href ={UrlHelper.imageUrl(this.state.verifyItem[index-1].image4)} target="_blank"><img src={UrlHelper.imageUrl(this.state.verifyItem[index-1].image4)} className="img-thumbnail-verify"
                                                        alt=""/></a>
                                            </div>}
                                            {this.state.verifyItem[index-1].image5 &&
                                            <div style={{float :'left'}}>
                                                <a href ={UrlHelper.imageUrl(this.state.verifyItem[index-1].image5)} target="_blank"><img src={UrlHelper.imageUrl(this.state.verifyItem[index-1].image5)} className="img-thumbnail-verify"
                                                        alt=""/></a>
                                            </div>}
                                        </div>
                                </fieldset>}
