...
class AreaCode extends Component {
    ...
    componentDidMount() {
        ...
        this.props.actions.changeThemeTitle("Mã vùng");
    }
    ...
    render() {
        ...
        if (!userPermissions.area_code || !userPermissions.area_code.index) return <ForbiddenPage/>;
...
export default connect(mapStateToProps, mapDispatchToProps)(AreaCode)
