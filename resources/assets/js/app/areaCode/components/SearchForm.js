            ...
            <form className="form-horizontal" onSubmit={handleSubmit(this.handleFilterSubmit.bind(this))}>
                ...
                <div className="row">
                    <div className="col-sm-6">
                        <Field name="name" component={TextInput} label="Tên vùng"/>
                    </div>
                    <div className="col-sm-6">
                        <Field name="code" component={TextInput} label="Mã vùng"/>
                    </div>
                </div>
...
function mapStateToProps({areaCode}) {
    return {
        search: areaCode.search,
    }
}
