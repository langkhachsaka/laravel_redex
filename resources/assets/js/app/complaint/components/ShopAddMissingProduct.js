...
class ShopAddMissingProduct extends Component {
    ...
    changeData(model,rootModel){
        ...
        if(rootModel.status >= Constant.STATUS_ORDER_OFFICER_PROCESSED) {
            ...
            this.props.change(model.case + '.add_lading_code',model.add_lading_code);
    ...
    render() {
        ...
        return (
                ...
                <fieldset className="fiedset-verify-customer-order bgc-grey">
                    <legend  className="legend-account-deposited">Shop bổ sung hàng thiếu</legend>
                    <div className={"row"}>
                    ...
                    <div className={"row"}>
                        <div className={"col-sm-2 top-10px"}>
                            Thêm mã vận đơn
                        </div>
                        <div className={"col-sm-10"}>
                            <Field
                                name={model.case + ".add_lading_code"}
                                label={''}
                                component={TextInput}
                                disabled={confirmed}
                                validate={[Validator.required]}
                    ...
                    <div className={"row"}>
                        ...
                        <div className={"col-sm-10"}>
                            <Field
                                ...
                                onDateChange={(date) => {
                                    this.props.change(model.case + ".date_of_delivery", date.format("YYYY-MM-DD"));
                                }}
                                name={model.case + ".date_of_delivery"}
                                disabled={confirmed}
                                validate={[Validator.required]}
                            />
                        </div>
...
ShopAddMissingProduct.propTypes = {
