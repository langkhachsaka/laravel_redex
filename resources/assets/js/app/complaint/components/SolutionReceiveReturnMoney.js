...
class SolutionReceiveReturnMoney extends Component {
    ...
    render() {
        ...
        return (
                ...
                <fieldset className="fiedset-verify-customer-order bgc-grey">
                    <legend  className="legend-account-deposited">Nhận hàng và bồi hoàn tiền từ Shop</legend>
                        ...
                        <div className="col-sm-3">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <div className="margin-bottom-10px" style={{marginRight:'20px'}}>Ship nội địa:</div>
                                        </td>
                                        <td>
                                            <Field
                                                label={''}
...
SolutionReceiveReturnMoney.propTypes = {
